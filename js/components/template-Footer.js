const footer = `
    ...
    <a class="btn btn-secondary" href="https://docs.google.com/forms/d/e/1FAIpQLSfoe5bxjjASle0FQSNtxvEvL73yVqlXtedVCcLs0-uOYwfHmA/viewform?usp=pp_url&entry.542052009=Educação+Digital+e+o+Mercado+de+Trabalho" target="_blank">Avaliar este recurso</a>
    <!-- REPORTAR ERRO -->
    <!-- Atualizar "Nome+do+Recurso" -->
    <a class="btn btn-secondary" href="https://docs.google.com/forms/d/e/1FAIpQLSeE4DT6yuFY4wArPAPQ86GMbRLFwnlTLG-C-s5t2mFdRkR8bA/viewform?usp=pp_url&entry.1523910789=Educação+Digital+e+o+Mercado+de+Trabalho" target="_blank">Reportar erro</a>
    </div>
