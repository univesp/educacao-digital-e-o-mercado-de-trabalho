const mobileContent = `
  ...
  <!--  CONTEUDO 1 - A INTERNET -->
    <div class="mobile-title-container">
      <span class="titulo-secao-mobile">A Internet</span>
      <span class="line-title-mobile"></span>
    </div>

    <div class="imagem-mobile img-bg-1">
  ...
  <!--  CONTEUDO 2 - O QUE É EDUCAÇÃO DIGITAL? -->
    <div class="mobile-title-container">
      <span class="titulo-secao-mobile">O que é educação digital?</span>
      <span class="line-title-mobile"></span>
    </div>

    <div class="imagem-mobile img-bg-2">
  ...
  <!--  CONTEUDO 3 - TECNOLOGIA NA EDUCAÇÃO -->
    <div class="mobile-title-container">
      <span class="titulo-secao-mobile">Tecnologia na Educação</span>
      <span class="line-title-mobile"></span>
    </div>
    ...
    <div class="videos-mobile">
      <iframe src="https://www.youtube.com/embed/KcEBAnDh-u4"></iframe>
    </div>


    <!--  CONTEUDO 4 - EAD -->
    <div class="mobile-title-container">
      <span class="titulo-secao-mobile">EAD</span>
      <span class="line-title-mobile"></span>
    </div>

    <div class="imagem-mobile img-bg-3">
    ...
    <!--  CONTEUDO 5 - EVOLUÇÃO DA EDUCAÇÃO -->
      <div class="mobile-title-container">
        <span class="titulo-secao-mobile">Evolução da Educação</span>
        <span class="line-title-mobile"></span>
      </div>
    ...
    <!--  CONTEUDO 6 - NOVAS REALIDADES NA ESCOLA -->
      <div class="mobile-title-container">
        <span class="titulo-secao-mobile">Novas Realidades na Escola</span>
        <span class="line-title-mobile"></span>
      </div>
      ...
      <div class="videos-mobile">
        <iframe src="https://www.youtube.com/embed/Eu5S8MBLKWE"></iframe>
      </div>


    <!--  CONTEUDO 7 - MERCADO DE TRABALHO -->
      <div class="mobile-title-container">
        <span class="titulo-secao-mobile">Mercado de Trabalho</span>
        <span class="line-title-mobile"></span>
      </div>
  
      <div class="imagem-mobile img-bg-4">
      ...
      <div class="conteudo8-container">
            ...
            <div class="conteudo-content">
                <p class="content-conteudo8" id="content8-1"><strong>Primário </strong>- Lida diretamente com a matéria-prima, como a agricultura, a pecuária e a extração mineral e vegetal;</p>            
            </div>
        </div>

        <div class="conteudo8-container">
            <div class="conteudo-content">
                <p class="content-conteudo8" id="content8-2"><strong>Secundário </strong>- Lida com a modificação da matéria-prima, construindo objetos utilizáveis, como as indústrias e a construção civil;</p>            
            </div>
        ...
        <div class="conteudo8-container">
            ...
            <div class="conteudo-content">
                <p class="content-conteudo8" id="content8-3"><strong>Terciário </strong>- Relacionadas a prestação de serviços, como: bancos, hospitais, escolas, mercados, ou seja, quando a forma de trabalho lida com pessoas e não com os objetos como principal foco de atuação.</p>  
            </div>
        </div>


    <!--  CONTEUDO 8 - ERA DIGITAL -->
      <div class="mobile-title-container">
        <span class="titulo-secao-mobile">Era Digital</span>
        <span class="line-title-mobile"></span>
      </div>
