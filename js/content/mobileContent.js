    ...
    <!--  CONTEUDO 7 - MERCADO DE TRABALHO -->
      ...
      <div class="conteudo8-container">
        ...
        <div class="conteudo8-container">
            ...
            <div class="conteudo-content">
                <p class="content-conteudo8" id="content8-3"><strong>Terciário </strong>- Está relacionado à prestação de serviços, como: bancos, hospitais, escolas, mercados, ou seja, quando o trabalho tem como principal foco de atuação as pessoas e não os objetos.</p>  
            </div>
        </div>
